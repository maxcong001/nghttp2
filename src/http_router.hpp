...
template <typename requestTypename, typename responseTypename>
class http_router {
public:
  static http_router &getInstance() {
  ...
  bool route(const std::string &method, const std::string url,
             requestTypename &req, responseTypename &res) {
...
private:
  ...
  void register_nonmember_func(const std::string raw_name,
                               const std::vector<std::string_view> &arr,
                               Function f, const AP &...ap) {
  ...
  template <typename Function, typename... AP>
  void invoke(requestTypename &req, responseTypename &res, Function f,
              AP... ap) {
    using result_type =
        std::result_of_t<Function(requestTypename &, responseTypename &)>;
  ...
  template <typename Function, typename Self, typename... AP>
  void invoke_mem(requestTypename &req, responseTypename &res, Function f,
                  Self self, AP... ap) {
  ...
  bool do_ap_before(requestTypename &req, responseTypename &res, Tuple &tp) {
    bool r = true;
    for_each_l(
        tp,
        [&r, &req, &res](auto &item) {
          ...
          constexpr bool has_befor_mtd =
              has_before<decltype(item), requestTypename &,
                         responseTypename &>::value;
  ...
  template <typename Tuple>
  void do_void_after(requestTypename &req, responseTypename &res, Tuple &tp) {
    bool r = true;
    for_each_r(
        tp,
        [&r, &req, &res](auto &item) {
          ...
          constexpr bool has_after_mtd =
              has_after<decltype(item), requestTypename &,
                        responseTypename &>::value;
  ...
  void do_after(T &&result, requestTypename &req, responseTypename &res,
                Tuple &tp) {
    bool r = true;
    for_each_r(
        tp,
        [&r, result = std::move(result), &req, &res](auto &item) {
          ...
          if constexpr (has_after<decltype(item), T, requestTypename &,
                                  responseTypename &>::value)
  ...
  // std::function<void(requestTypename &,
  // responseTypename &)>> invoker_function; 	std::map<std::string_view,
  // invoker_function> map_invokers_;

  RadixTree<requestTypename, responseTypename> tree;
};
} // namespace server
} // namespace asio_http2
} // namespace nghttp2
